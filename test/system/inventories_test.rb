...
class InventoriesTest < ApplicationSystemTestCase
  ...
  test "should create inventory" do
    ...
    fill_in "Id prod", with: @inventory.Id_prod
    fill_in "Brand", with: @inventory.brand
    fill_in "Category", with: @inventory.category
    fill_in "Code", with: @inventory.code
    fill_in "Cost price", with: @inventory.cost_price
    fill_in "Description", with: @inventory.description
    fill_in "Sale price", with: @inventory.sale_price
